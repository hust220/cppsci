...
namespace cppsci { namespace linalg {
...
struct eig {
        ...
        : a(_a)
    {
        ...
        int ldvl = n;
        int ldvr = n;
        info = LAPACKE_dgeev(LAPACK_ROW_MAJOR, 'N', 'V', n, a.data, lda, wr.data, wi.data, vl.data, ldvl, vr.data, ldvr );
    }
};
...
struct svd {
    ...
    {
        info = LAPACKE_dgesvd( LAPACK_ROW_MAJOR, 'A', 'A', m, n, a.data, lda,
